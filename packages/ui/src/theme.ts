 ...
 * Derived from KZN Youth Choir logo
...
export const theme = {
  colors: {
    ...
    primary: {
      ...
      300: '#93C5FD',
      400: '#60A5FA',
      500: '#3B82F6', // Light blue from logo
      600: '#2563EB',
      700: '#1D4ED8',
      800: '#1E40AF',
    ...
    // Accent colors from logo letters
    accent: {
      red: '#DC2626', // K
    ...
    // Neutrals - Swiss style prefers clean grays
    neutral: {
      50: '#FAFAFA',
      100: '#F5F5F5',
      200: '#E5E5E5',
